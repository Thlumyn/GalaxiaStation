...
/obj/item/robot_model/peacekeeper
	borg_skins = list(
		...
		"Foxtrot" = list(SKIN_ICON_STATE = "ftpeace", SKIN_ICON = CYBORG_ICON_PEACEKEEPER_TALL, SKIN_FEATURES = list(TRAIT_R_UNIQUEWRECK, TRAIT_R_UNIQUEPANEL, TRAIT_R_TALL), SKIN_HAT_OFFSET = 15)
	)
